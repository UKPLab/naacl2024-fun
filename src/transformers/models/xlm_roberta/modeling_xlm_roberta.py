...
from ..roberta.modeling_hyper_roberta import (
    RobertaForQuestionAnswering as HyperRobertaForQuestionAnswering,
    RobertaForMultipleChoice as HyperRobertaForMultipleChoice,
    RobertaForSequenceClassification as HyperRobertaForSequenceClassification, 
    RobertaForTokenClassification as HyperRobertaForTokenClassification 
)
...
class HyperXLMRobertaForSequenceClassification(HyperRobertaForSequenceClassification):
    """
    This class overrides [`RobertaForSequenceClassification`]. Please check the superclass for the appropriate
    documentation alongside usage examples.
    """
...
class HyperXLMRobertaForMultipleChoice(HyperRobertaForMultipleChoice):
    """
    This class overrides [`RobertaForMultipleChoice`]. Please check the superclass for the appropriate documentation
    alongside usage examples.
    """
...
class HyperXLMRobertaForTokenClassification(HyperRobertaForTokenClassification):
    """
    This class overrides [`RobertaForTokenClassification`]. Please check the superclass for the appropriate
    documentation alongside usage examples.
    """
...
class HyperXLMRobertaForQuestionAnswering(HyperRobertaForQuestionAnswering):
    """
    This class overrides [`RobertaForQuestionAnswering`]. Please check the superclass for the appropriate documentation
    alongside usage examples.
    """
